    ...
    <li class="nav_li" style="float:left;"><a class="nav_a" style="width:100px; text-align:center;" href="order.php">Carrello</a>
      <ul class="dropdown_ul">
        <?php
          ...
          $cart_items = $conn->query("SELECT f.id_f, o.id_o, f.capacita, c.quantita, c.importo_parziale, p.nome FROM carrello as c, formato as f, prodotto as p, ordine as o WHERE o.stato=0 AND c.id_f = f.id_f AND f.id_p=p.id_p AND c.id_o=o.id_o AND o.id_u=".$_SESSION['id_u']);
          ...
          echo("<th class='dropdown_td'>Totale</th>");
          ...
          while($cart_item){
            ...
            echo("<td class='dropdown_td'>".$cart_item["capacita"]." ml</td>");
            ...
            echo("<td class='dropdown_td'><a href='remove_cart_item.php?id_o=".$cart_item["id_o"]."&id_f=".$cart_item["id_f"]."'><img style='width:10px; height:10px' src='Images/x_icon.jpg'</a></td>");
            echo("</tr>");
            $cart_item = mysqli_fetch_assoc($cart_items);
          }
          echo("</table></li>");
          echo("<li class='dropdown_li' style='width:100%'><a class='checkout_a' href='order.php'><div class='checkout_div'>Checkout</div></a></li>");
        ?>
        </ul>
    </li>
